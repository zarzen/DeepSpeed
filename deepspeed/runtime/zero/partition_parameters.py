...
class Init(InsertPostInitMethodToModuleSubClasses):
    ...
    def _all_gather(self, param_list, async_op=False, hierarchy=None):
        ...
        if not async_op:
            ...
            ret_value = self._allgather_params_rework(all_gather_list, hierarchy=hierarchy)
    ...
    def _allgather_params_rework(self, param_list, hierarchy=0):
        """ blocking op,
            launch multiple allgather ops
        """
        if len(param_list) == 0:
            return
